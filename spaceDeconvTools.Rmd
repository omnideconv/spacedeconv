...
# deconvolute
deconvolution <- omnideconv::deconvolute(counts(sp), signature=signature, method="scdc", verbose=TRUE, single_cell_object=sc, cell_type_column_name = "cell_ontology_class", batch_ids = batch_ids)
...
ggspavis::plotSpots(sp, x, y, annotate = "Macrophage", size=1)
ggspavis::plotSpots(sp, x, y, annotate = "Endothelial.cell", size=1)
ggspavis::plotSpots(sp, x, y, annotate = "NK.cell", size=2)
```
