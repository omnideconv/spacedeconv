...
```{r plotUMIcount, fig.width=7, fig.height=7, message=FALSE, warning=FALSE}
...
```{r plotMostAbundant, fig.width=7, fig.height=7, message=FALSE, warning=FALSE}
...
```{r plotComparison, fig.width=7, fig.height=7, message=FALSE, warning=FALSE}
...
```{r availablePalettes, fig.width=12, fig.height=9, out.width="95%", fig.retina=2, fig.align='center'}
...
```{r offset_rotation, eval = TRUE, fig.width=14, fig.height=7, out.width="95%", fig.retina=2, fig.align='center', message=FALSE, warning=FALSE}
...
```{r, fig.width=14, fig.height=7, out.width="95%", fig.retina=2, fig.align='center', message=FALSE, warning=FALSE}
spacedeconv::plot_spatial(deconv,
  result = "spatialdwls_B.cells",
  smooth = TRUE,
  density = TRUE,
