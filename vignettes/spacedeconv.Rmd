...
The core modules of spacedeconv are used to build a reference signature and deconvolute spatial transcriptomics data. We further provide convenient function for normalization and visualization. A full list of deconvolution algorithms can be accessed by `spacedeconv::deconvolution_methods` or in the [FAQ](spacedeconv_faq.html).
...
```
### 4. Visualization 
We offer 4 visualization function aiming different insight of the data. A full example of each visualization option is available in the visualization [Vignette](spacedeconv_visualization.html).
