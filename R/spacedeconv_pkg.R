...
#' @importFrom ggplot2 aes aes_string unit element_rect ggtitle coord_fixed geom_text geom_point geom_abline xlab ylab discrete_scale element_text labs aes_ ggplot geom_density theme_classic theme_minimal geom_vline scale_fill_viridis_c scale_y_discrete theme annotation_raster geom_sf coord_sf element_blank scale_fill_brewer scale_fill_manual
