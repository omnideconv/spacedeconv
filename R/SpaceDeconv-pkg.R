...
#' @importFrom ggplot2 aes aes_string discrete_scale labs aes_ ggplot geom_density theme_classic geom_vline scale_fill_viridis_c scale_y_discrete theme annotation_raster geom_sf coord_sf element_blank
